...
* `Lumina <https://forums.pcbsd.org/forum-26.html>`_: this forum is for the discussion of the Lumina desktop.
...
* **Channel name:** #trueos (note that the # is required) 
...
`web interface to #trueos <http://irc.lc/freenode/trueos>`_.  
